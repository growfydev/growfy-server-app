import { Controller, Get, Post, Body, Patch, Param, Delete, Query, HttpException, HttpStatus, ParseIntPipe, UseInterceptors, UploadedFile } from '@nestjs/common';
    ...
    worksheet.eachRow((row, rowNumber) => {
      ...
      if (name) {
        customers.push({
          ...
          globalStatus: globalStatus ? globalStatus.toString().trim() : undefined
        });
      }
    });
